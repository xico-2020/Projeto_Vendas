...
using VendasWebMvc.Models; // Namespace de VendasWebMvcContext.cs
...
namespace VendasWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()  // Função responsavel por "criar" a Base Dados
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);  // d1 é o Departamento. Faço já a associação dos objetos.
